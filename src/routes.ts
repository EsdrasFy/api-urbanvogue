...
import { productById, productByIds } from "./controllers/product/product-by-id/product-by-id.controller";
import {
  filterProducts,
  productSearch,
...
routes.get("/forgot-password/:email", sendEmail);
routes.get("/forgot-password/verify/:code/:email", sendCode);
